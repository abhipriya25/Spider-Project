...
class SovcombankSpider(scrapy.Spider):
    ...
    start_urls = ['https://prod-api.sovcombank.ru/points?lang=ru&location=55.641533109991876,37.42227915722656,55.86612820665731,37.82190684277345&type=office&reference=55.753993,37.622093&for_individual=true']
