...
class BP_GLOBAL_Spider(scrapy.Spider):
    ...
    spider_countries: List[str] = [
        ...
        pycountry.countries.lookup('gb').alpha_2,
        pycountry.countries.lookup('ie').alpha_2,
        pycountry.countries.lookup('ch').alpha_2,
        pycountry.countries.lookup('za').alpha_2,
        pycountry.countries.lookup('pt').alpha_2,
        pycountry.countries.lookup('at').alpha_2,
        pycountry.countries.lookup('nl').alpha_2
