...
class Shell_DNK_Spider(scrapy.Spider):
    ...
    spider_countries: List[str] = [pycountry.countries.lookup('dk').alpha_2]
    allowed_domains: List[str] = ['www.shell.dk','shellfleetlocator.geoapp.me']
