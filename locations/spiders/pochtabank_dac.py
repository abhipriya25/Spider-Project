...
class PochtaBankSpider(scrapy.Spider):
    ...
    start_urls = ['https://my.pochtabank.ru/api/mapsdkpoi/map?&type=postEmployeeInPostOffice&type=clientCenter&type=miniOffice&type=bankEmployeeInPostOffice&type=terminal&type=mfc&type=atmPochtaBank&tile=[0,0]&zoom=0']
